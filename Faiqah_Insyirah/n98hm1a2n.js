...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (form && popup) {
    form.addEventListener("submit", function (e) {
      const kehadiran = document.querySelector('input[name="entry.388638091"]:checked');
...
fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vSRd9yKo1cplBTyD3gQ4IbVRAf9XYZe5xAwJ5Twg-fBMaepirshCNOZgUYxDovTceSPjhOB4IFHptXy/pub?gid=709719923&single=true&output=csv")
  .then(response => response.text())
  .then(data => {
