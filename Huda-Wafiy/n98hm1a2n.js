 ...
 // 📨 Validasi sebelum submit
  if (form) {
    form.addEventListener("submit", function (e) {
      const kehadiran = document.querySelector('input[name="entry.1634786673"]:checked');    
...
fetch("https://docs.google.com/spreadsheets/d/e/2PACX-1vSduyemPfugzm5klp34l0oQ2FotA9FKdEuRvOHH245tq5XXYHnBK2_Q7v7lS9_Sb8uOMeuQEn-uD-Id/pub?gid=2009283930&single=true&output=csv")
